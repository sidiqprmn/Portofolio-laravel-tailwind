        ...
        l(it, et, {
            ...
            attrTest: function (t) {
                return (
                    ...
                    (this.state & ve ||
                        (!(this.state & ve) && this.directionTest(t)))
                );
            },
            emit: function (t) {
            ...
            $(".header--nav-toggle").click(function () {
                ...
                $(".outer-nav--return, .outer-nav li").click(function () {
                    $(".perspective").removeClass(
                        ...
                        $(
                            ".outer-nav, .outer-nav li, .outer-nav--return"
                        ).removeClass("is-vis");
                });
        }
        function s() {
